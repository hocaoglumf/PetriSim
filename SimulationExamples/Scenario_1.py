...
pg.SetTransitionDurationCalculation({"t0":
            "RandomValueGeneration.RandomValueCalculation.Exponential(1.3)"})
...
pg0.SetTransitionDurationCalculation({"t0":
            "RandomValueGeneration.RandomValueCalculation.Exponential(2.3)"})
...
pm3.SetTransitionDurationCalculation({"t0": -1, "t1":
    "RandomValueGeneration.RandomValueCalculation.Exponential(.7)"})
...
pm4.SetTransitionDurationCalculation({"t0": -1, "t1":
    "RandomValueGeneration.RandomValueCalculation.Uniform(5,1)"})
